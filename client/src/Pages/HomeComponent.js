...
const HomeComponent = () => {
    ...
    return (
        <>
            <div class="hero min-h-screen" style={{ backgroundImage: `url(${banner})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
                <div class="hero-overlay bg-opacity-60"></div>
                <div class="hero-content text-center text-neutral-content">
                    <div class="max-w-md">
                    <h1 class=" text-xl "><small className='text-xl'>Hi, I'M</small></h1>
                        <h1 class="mb-5 text-5xl text-primary font-bold " style={{ textShadow: '5px 5px 5px #FFFFFF' }}>Mahbub Noyon</h1>
