                        ...
                        <div class="card-body">
                            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                                <AccordionSummary
                                    ...
                                    id="panel1bh-header"
                                >
                                    <Typography sx={{ width: '33%', fontSize: '20px', color: '#2286CE', flexShrink: 0 }}>
                            ...
                            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                                <AccordionSummary
                                    ...
                                    id="panel2bh-header"
                                >
                                    <Typography sx={{ width: '33%', fontSize: '20px', color: '#2286CE', flexShrink: 0 }}>Secondary School Certificate</Typography>
