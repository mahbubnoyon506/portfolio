...
const Blogs = () => {
    return (
        <div className="pt-10 pb-20" style={{ backgroundImage: `url(${blogbg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <h1 className="pb-10 text-5xl font-bold pl-20">Recent Blogs</h1>
            <div className='hero'>
